...
import random
from scrapers import upkeep_scraping, fmi_scrapping, qad_scrapping, facilio_scrapping, facilitiesnet_scrapping, fmnaz_scrapping, fmmedia_aus_scrapping
...
class Scraper():
    ...
    def scrape_news(self, site):
        ...
        try:
            ...
            elif site == "FACILIESNET":
                logger.info("Scraping FACILIESNET Journal")
                scraped = facilitiesnet_scrapping.main()
                
            elif site == "FMNAZ":
                logger.info("Scraping FMNAZ Journal")
                scraped = fmnaz_scrapping.main()
                
            elif site == "FMMEDIA_AUS":
                logger.info("Scraping FMMEDIA_AUS Journal")
                scraped = fmmedia_aus_scrapping.main()
...
def start_scraping():
    ...
    scrape.contents.extend(scrape.scrape_news("FACILIESNET"))
    
    scrape.contents.extend(scrape.scrape_news("FMNAZ"))
